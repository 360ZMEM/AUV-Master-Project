...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\linewidth,height=0.86\textheight,keepaspectratio,alt={平衡三相螺旋导体的几何、横截面漏磁方向以及沿绞距变化的三轴磁场分量和均方根模量}]{magnetics/three_phase_helical_field.pdf}
\caption{平衡三相螺旋电缆的定性磁场仿真：（a）三芯螺旋几何与观测线上归一化的瞬时磁场方向；（b）\(i_A+i_B+i_C=0\) 时的横截面漏磁场；（c）瞬时三轴分量随轴向旋转，而三轴 RMS 模量保持近似稳定}\label{fig:ch02-three-phase-helical-field}
\end{figure}
\FloatBarrier
