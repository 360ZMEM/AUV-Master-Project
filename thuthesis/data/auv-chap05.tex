...
三档地形均三次全部完成、无一例低于 1.5 m 的安全违规，离底 RMSE 落在 0.59--0.71 m 区间，说明地形参考与安全过滤在当前运动学后端和地形模型下具有稳定的近底安全性；该均值\allowbreak{}±标准差不外推为原生 PVS 内环的稳健统计。
