...
typedef struct
{
	/*$MCUFU ��Ӧ��16������ʾ 24 4D 43 55 46 55*/
	char McuFU_Head_Buf[6];
	u8 McuFU_Msg_Num;
	char McuFU_Back_ID[2];/*FK ��Ӧ��16������ʾ46 4B*/
	u16 McuFU_Pre_Para1;
	u16 McuFU_Pre_Para2;
	u16 McuFU_Pre_Para3;
...
typedef struct
{
	 ...
	 float BD_Height;
	 float BD_Time;
	 float BD_Check;/*����ȷ����char�𣿲�Ӧ����float��*/
...
{
	u8 head_buf;  /*1*/	
	float Roll_Pitch_Yaw[3];/*��λ�ǻ��ȣ�ת��Ϊ�Ƕȣ��Ͷ�Ӧ���ˣ�1����ԼΪ57.3�ȣ�1����=��180���ԦУ���*/	 
