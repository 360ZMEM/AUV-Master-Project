...
def build_run_metrics(
    *,
    ...
    return {
        ...
        "mpc_solve_time_p50_ms": percentile(solve_times, 50.0),
        "mpc_solve_time_p95_ms": percentile(solve_times, 95.0),
        "mpc_solve_time_p99_ms": percentile(solve_times, 99.0),
        ...
        "solver_wall_time_current_p50_ms": percentile(solver_wall_times, 50.0),
        "solver_wall_time_current_p95_ms": percentile(solver_wall_times, 95.0),
        "solver_wall_time_current_p99_ms": percentile(solver_wall_times, 99.0),
