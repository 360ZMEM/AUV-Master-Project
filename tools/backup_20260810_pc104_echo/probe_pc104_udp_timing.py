...
def write_report(output_dir: Path, summary: dict[str, Any]) -> None:
    lines = [
        ...
        "and PC104 uptime monotonicity. Without a synchronized Jetson--PC104 clock "
        "or firmware echo of the downlink timestamp, it must not be reported as "
        "one-way physical latency.",
        "",
