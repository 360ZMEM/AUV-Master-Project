#!/usr/bin/env python3
"""Convert canonical thesis Markdown chapters into ThuThesis LaTeX fragments."""
...
def render_latex(spec: ChapterSpec) -> bytes:
    ...
    header = (
        ...
        f"% Canonical source: {spec.source.relative_to(ROOT)}\n"
        f"% Source SHA256: {source_hash(source_data)}\n"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "canonical Markdown chapter to migrate (1-6); "
